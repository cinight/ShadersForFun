Shader "Unlit/HDRP_Ambient"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma target 4.5 // required for cube array
            ...
            float4 frag (v2f i) : SV_Target
            {
                ...
                context.sampleReflection = SINGLE_PASS_CONTEXT_SAMPLE_SKY; //ONLY this is different with reflection probe
